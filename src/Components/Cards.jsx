const Cards = () => {
    return (
      <div className="p-5 w-full h-screen flex flex-col lg:flex-row lg:p-10 md:p-5 items-center gap-5">
        <div className="cardcontainer w-full lg:w-1/2 h-[50vh]">
          <div className="card relative bg-[#004D43] rounded-xl w-full h-full flex items-center justify-center">
            <svg
              className="bg-inherit text-[#CDEA68] size-[15vh]"
              viewBox="0 0 72 30"
              fill="none"
            ...
            <button className="absolute left-5 bottom-5 lg:bottom-8 border-[1px] text-[0.7em] bg-zinc-900 text-[#CDEA68] border-[#CDEA68] rounded-full px-2">
              &copy; 2024
            </button>
          </div>
        </div>
        ...
        <div className="cardcontainer flex flex-col lg:flex-row gap-5 w-full lg:w-1/2 h-[50vh]">
          ...
          <div className="card rounded-xl w-full lg:w-1/2 h-full bg-[#212121] text-black card relative flex items-center justify-center">
            <img
              ...
              alt="Academy Logo"
            />
            <button className="absolute left-5 bottom-5 lg:bottom-8 bg-[#CDEA68] uppercase font-neue text-[0.7em] border-[1px] border-cyan-800 rounded-full px-2">
              BUSINESS BOOTCAMP
            </button>
          </div>
        </div>
